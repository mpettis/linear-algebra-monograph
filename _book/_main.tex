...
{\centering \includegraphics[width=0.5\linewidth,height=0.5\textheight]{images/ch01_single-vector-coords-red-circle-slash} 
...
{\centering \includegraphics[width=0.5\linewidth,height=0.5\textheight]{images/ch01_additive-inverse} 
...
\hypertarget{combo-moves}{%
\section{Combo moves}\label{combo-moves}}
...
{\centering \includegraphics[width=0.5\linewidth,height=0.5\textheight]{images/ch01_three-vector-resultant} 
...
{\centering \includegraphics[width=0.5\linewidth,height=0.5\textheight]{images/ch01_push-commutivity} 

}

\caption{One push instead of two}\label{fig:unnamed-chunk-5}
\end{figure}

\hypertarget{enough-experimenting-for-now}{%
\section{Enough Experimenting for Now}\label{enough-experimenting-for-now}}

A lot of talk of pushing and recording and choosing to observe weird things.
